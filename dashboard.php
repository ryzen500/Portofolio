...
<?php require 'assets/templates/header.php'; ?>
        ...
        <!-- Begin Page Content -->
        <div class="container-fluid" style="background-image: url(http://localhost/uprising-music-master/assets/images/awesome-feat-bg-1.png); background-size: cover; height: 90%;">
