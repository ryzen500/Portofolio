...
<html lang="en">
  <head>
    ...
    <title>Tsanytify!</title>
  </head>
  <body>

    <nav class="navbar navbar-expand-lg p-3">
      <div class="container">
        <a class="navbar-brand wow bounceInDown" href="#"><h3>Tsanytify!</h3></a>
    ...
    <section style="background-image: url(http://localhost/uprising-music-master/assets/images/feature-bg-1.png); background-size: cover;">
      <div class="container trends">
        ...
        <div class="row row3 p-3 text-center mb-3">
          <div class="col-lg">
            <h2><a href="dashboard.php" class="text-gray text-uppercase">Upload your own music.</a></h2>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="pb-5" style="background-image: url(http://localhost/uprising-music-master/assets/images/awesome-feat-bg-1.png); background-size: cover;">
      ...
      <div class="container">
        <div class="row">
            <div class="col-lg-10 col-md-12 pt-0">
                <p align="center">Copyright 2020 <a href="">Tsanytify.com</a> &copy; All Rights Reserved</p>
            </div>
